  ...
  return {
    ...
    async writeBundle() {
      ...
      const pages: StaticPage[] = [
        page('/', 'Çeliktepe Marangoz & Özel Ölçü Mobilya | Asya Mobilya', 'Çeliktepe\'de özel ölçü marangoz ve mobilya hizmetleri. Mutfak dolabı, gömme dolap, gardırop, TV ünitesi ve ahşap işler için Asya Mobilya Ahşap\'a ulaşın.', 'Mekâna yer açan ahşap.', { '@type': 'LocalBusiness', name: 'Asya Mobilya Ahşap' }),
